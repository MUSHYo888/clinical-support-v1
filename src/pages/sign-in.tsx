    ...
    <div className="min-h-screen flex flex-col md:flex-row font-geist w-full overflow-hidden bg-background">
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <div className="animate-element animate-delay-500 flex items-center justify-between text-sm">
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); onResetPassword?.(); }} className="hover:underline text-teal-600 transition-colors font-medium">Reset password</a>
              </div>

              <button type="submit" className="animate-element animate-delay-600 w-full rounded-2xl bg-teal-600 py-4 font-medium text-white hover:bg-teal-700 transition-colors shadow-md hover:shadow-lg">
                Sign In
              </button>
            </form>
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground mt-4">
              New to our platform? <a href="#" onClick={(e) => { e.preventDefault(); onCreateAccount?.(); }} className="text-teal-600 hover:text-teal-500 hover:underline transition-colors font-medium">Create Account</a>
            </p>
          </div>
        </div>
      </section>
      ...
      {heroImageSrc && (
        <section className="hidden md:flex flex-1 relative p-4">
          ...
          <div className="absolute inset-4 rounded-3xl bg-teal-900/30 pointer-events-none"></div>
