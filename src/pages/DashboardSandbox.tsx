...
const recentPatients: PatientCase[] = [
  { 
    ...
    differentials: [
      { name: "Pneumonia", confidence: 85, resources: [{ site: "StatPearls (NCBI)", url: "https://www.ncbi.nlm.nih.gov/books/NBK526116/" }, { site: "NICE Guidelines", url: "https://www.nice.org.uk/guidance/ng138" }] }, 
      { name: "Acute Bronchitis", confidence: 45, resources: [{ site: "BMJ Best Practice", url: "https://bestpractice.bmj.com/topics/en-gb/3000206" }] }, 
      { name: "Pulmonary Embolism", confidence: 15, resources: [{ site: "ESC Guidelines", url: "https://www.escardio.org/Guidelines" }] }
    ],
    soapNotes: [{ id: 1, date: "2026-04-24", preview: "Pt stable, afebrile, completing IV antibiotics course." }, { id: 2, date: "2026-04-25", preview: "Increased wheezing noted, starting nebs." }]
  },
  { 
    id: "PAT-892103445", name: "James Wilson", age: 42, gender: "male", date: "4/24/2026", chiefComplaint: "CC: Sharp RLQ abdominal pain", status: "In Progress",
    differentials: [
      { name: "Appendicitis", confidence: 92, resources: [{ site: "StatPearls (NCBI)", url: "https://www.ncbi.nlm.nih.gov/books/NBK493193/" }, { site: "ACOG Guidelines", url: "https://www.acog.org/" }] }, 
      { name: "Gastroenteritis", confidence: 30, resources: [{ site: "CDC Guidelines", url: "https://www.cdc.gov/" }] }, 
      { name: "Kidney Stone", confidence: 10, resources: [{ site: "AUA Guidelines", url: "https://www.auanet.org/" }] }
    ],
    soapNotes: []
  },
  { 
    id: "PAT-112993002", name: "Sarah Connor", age: 28, gender: "female", date: "4/23/2026", chiefComplaint: "CC: Persistent headache and nausea", status: "Incomplete",
    differentials: [
      { name: "Migraine", confidence: 88, resources: [{ site: "AHS Guidelines", url: "https://americanheadachesociety.org/" }] }, 
      { name: "Tension Headache", confidence: 50, resources: [{ site: "StatPearls (NCBI)", url: "https://www.ncbi.nlm.nih.gov/books/NBK531462/" }] }, 
      { name: "Meningitis", confidence: 5, resources: [{ site: "IDSA Guidelines", url: "https://www.idsociety.org/practice-guideline/bacterial-meningitis/" }] }
    ],
    soapNotes: []
  },
  { 
    id: "PAT-774829103", name: "Michael Chang", age: 64, gender: "male", date: "4/23/2026", chiefComplaint: "CC: Bilateral lower extremity edema", status: "Finalized",
    differentials: [
      { name: "Congestive Heart Failure", confidence: 80, resources: [{ site: "ACC/AHA Guidelines", url: "https://www.acc.org/guidelines" }] }, 
      { name: "Venous Insufficiency", confidence: 60, resources: [{ site: "StatPearls (NCBI)", url: "https://www.ncbi.nlm.nih.gov/books/NBK430975/" }] }, 
      { name: "Deep Vein Thrombosis", confidence: 20, resources: [{ site: "ACCP Guidelines", url: "https://journal.chestnet.org/guidelines" }] }
    ],
    soapNotes: [{ id: 3, date: "2026-04-23", preview: "Diuresis initiated. Output 1.5L positive." }]
  },
  { 
    id: "PAT-339201994", name: "Emma Thompson", age: 35, gender: "female", date: "4/22/2026", chiefComplaint: "CC: Sudden onset palpitations", status: "In Progress",
    differentials: [
      { name: "Atrial Fibrillation", confidence: 75, resources: [{ site: "ESC Guidelines", url: "https://www.escardio.org/Guidelines" }] }, 
      { name: "Panic Attack", confidence: 65, resources: [{ site: "APA Guidelines", url: "https://www.psychiatry.org/psychiatrists/practice/clinical-practice-guidelines" }] }, 
      { name: "Hyperthyroidism", confidence: 35, resources: [{ site: "ATA Guidelines", url: "https://www.thyroid.org/professionals/ata-professional-guidelines/" }] }
    ],
    soapNotes: [{ id: 4, date: "2026-04-22", preview: "Rate controlled on diltiazem. Awaiting echo." }]
  },
];
...
export default function Dashboard() {
  ...
  const filteredPatients = (recentPatients || []).filter(patient => {
    if (activeFilter === "Incomplete") return patient.status === "Incomplete";
    if (activeFilter === "In Progress") return patient.status === "In Progress";
    if (activeFilter === "Finalized") return patient.status === "Finalized";
        ...
        >
          <Card>
            <CardHeader className="pb-2">
              ...
              <div className="flex flex-row overflow-x-auto gap-2 pt-4 pb-2 scrollbar-hide">
            ...
            <CardContent>
              {filteredPatients.length === 0 ? (
                <div className="py-8 text-center text-sm text-muted-foreground">
                  No patients currently match this status.
                </div>
              ) : (
                  ...
                  <div key={patient.id} className="rounded-lg border overflow-hidden bg-card transition-colors">
                    ...
                    >
                      ...
                      <div className="flex items-center text-right">
                        ...
                        <p className="font-medium text-foreground">ID: {patient.id}</p>
